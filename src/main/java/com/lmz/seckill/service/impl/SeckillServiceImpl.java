package com.lmz.seckill.service.impl;
...
import com.lmz.seckill.dao.SuccessKilledDao;
import com.lmz.seckill.dao.cache.RedisDao;
...
import com.lmz.seckill.enums.SeckillStateEnum;
...
import com.lmz.seckill.service.SeckillService;
...
public class SeckillServiceImpl implements SeckillService {
	...
	//md5盐值字符串，用于混淆MD5
	private final String salt = "jojdfasoP$(*&()@JOPJ~∆øß∆∑oiwejio935";
	 ...
	 * 3:不是所有的方法方法都需要事务，如只有一条修改操作，只读操作是不需要事务控制
	 */
